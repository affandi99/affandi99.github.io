      ...
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        <form class="login100-form validate-form flex-sb flex-w">
          <span class="login100-form-title " >
            <h3>Rincian Pemesanan</h3><hr>
          </span>   
          <span class="txt1 p-b-11">
            Membeli Kelas Pelatihan dengan harga Rp150.000,00
          </span><br>
          <p> Metode pembayaran </p><hr>
          
          <div class="flex-sb-m w-full p-b-48">
            <div class="contact100-form-checkbox " >
              <input type="radio" value="metode"><img src="assets/img/ATMBersama.png " width="60px" height="40px"> Transfer Antar Bank<br>
            </div>
          ...
          <div class="col-lg-4 text-lg-left">
            <a class= "btn btn-dark" href="<?php echo base_url('C_home');?>">Kembali</a>
          </div>
          <div class="col-lg-4 text-lg-right">
            <a class="btn btn-dark" href="<?php echo base_url('C_checkout');?>">Lanjut</a>
          </div>
