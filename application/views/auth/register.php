      ...
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        <form class="login100-form validate-form flex-sb flex-w">
          ...
          <div class="wrap-input100 validate-input m-b-12" data-validate = "Nama is required">
            <input class="input100" type="text" name="nama_umkm" >
            <span class="focus-input100"></span>
          </div>
          ...
          <div class="wrap-input100 validate-input m-b-12" data-validate = "Nama is required">
            <input class="input100" type="text" name="nama_pemilik" >
            <span class="focus-input100"></span>
          </div>          
          ...
          <div class="wrap-input100 validate-input m-b-12" data-validate = "Nama Barang is required">
            <input class="input100" type="text" name="jenisbarang" >
            <span class="focus-input100"></span>
          </div>          
          <span class="txt1 p-b-11">
            Lokasi
          </span>
          <div class="wrap-input100 validate-input m-b-12" data-validate = "Lokasi is required">
            <input class="input100" type="text" name="lokasi" >
            <span class="focus-input100"></span>
          </div>
          ...
          <div class="flex-sb-m w-full p-b-48">
            ...
            <div>
              <a href="<?= base_url('C_login');?>" class="txt3">
                Login
              </a>
            </div>
          </div>
          ...
          <div class="container-login100-form-btn">
            <a href="<?= base_url('C_login');?>" class="login100-form-btn">
              Register
            </a>
          </div>
