    ...
    <div class="container-login100">
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        <form class="login100-form validate-form flex-sb flex-w">
          ...
          <h8> Pilih salah satu bank </h8><hr>

          <div class="flex-sb-m w-full p-b-48">
            
              <input type="radio" value="BRI" name="Bank"><img src="assets/img/BRI.png " width="60px" height="40px">
              <input type="radio" value="BCA" name="Bank"><img src="assets/img/BCA.png " width="60px" height="40px">
              <input type="radio" value="BNI" name="Bank"><img src="assets/img/BNI.png " width="60px" height="40px">
              <input type="radio" value="MANDIRI" name="Bank"><img src="assets/img/mandiri.png " width="60px" height="40px">
          ...
          <div class="col-lg-4 text-lg-left">
            <a class= "btn btn-dark" href="<?php echo base_url('C_pembayaran');?>">Kembali</a>
          </div>
          <div class="col-lg-4 text-lg-right">
            <a class="btn btn-dark" href="<?php echo base_url('C_upload');?>">Lanjut</a>
          </div>
